...
export const DashboardTab = ({ scanResult, onNavigateScanner, onNavigateAuditor }) => {
  ...
  const filesScanned = scanResult?.files_scanned || 1;
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="space-y-3 max-w-2xl">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <Button onClick={onNavigateScanner} size="sm" className="gap-2 bg-indigo-600 hover:bg-indigo-500 text-white shadow-lg shadow-indigo-600/20 font-medium">
                <Sparkles className="w-4 h-4" />
                Upload & Inspect Pipeline
              </Button>
              <Button onClick={onNavigateAuditor} variant="outline" size="sm" className="gap-2 border-slate-700 bg-slate-800/80 hover:bg-slate-700 text-slate-200">
            ...
            filteredIssues.slice(0, 5).map((issue, idx) => (
              ...
              >
                ...
                <Button 
                  ...
                  variant="outline" 
                  size="sm" 
                  className="shrink-0 gap-1 text-xs border-indigo-500/40 text-indigo-300 hover:bg-indigo-950/40 self-start sm:self-center"
                >
