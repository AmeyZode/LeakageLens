...
### 2. Core Python Package Directory (`/leakagelens/`)
...
### 4. Sample Projects Directory (`/sample_projects/`)
...
### 5. Package Metadata Directory (`/leakagelens.egg-info/`)
